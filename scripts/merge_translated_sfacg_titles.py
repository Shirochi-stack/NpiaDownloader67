"""Merge translated SFACG titles back into sfacg_titles_en.txt.

Reads: docs/data/sfacg_titles_untranslated.txt (with column 3 now filled in)
Updates: docs/data/sfacg_titles_en.txt (preserves existing, adds new translations)
...
MAIN = os.path.join("docs", "data", "sfacg_titles_en.txt")
PATCH = os.path.join("docs", "data", "sfacg_titles_untranslated.txt")
